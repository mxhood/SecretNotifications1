...
public class RankPatternsDrag4 extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decide_priority_4);
        ...
        String instructionsText = String.format(res.getString(R.string.patternChooseTxt), "4");
...
//            Toast.makeText(this, gpxfile.getAbsolutePath(), Toast.LENGTH_LONG).show();
    ...
    public void onBtnDoneClick(View view) {
        ...
        if (layerA == null || layerB == null || layerC == null || layerD == null) {
            Toast.makeText(this, "Please assign a pattern to each layer", Toast.LENGTH_SHORT).show();
        } else {
            String sFileName = "user" + userId + "Order4.txt";
